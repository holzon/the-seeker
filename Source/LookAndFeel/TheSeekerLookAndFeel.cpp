...
#include "TheSeekerLookAndFeel.h"

namespace juce {

Colour TheSeekerLookAndFeel::ColourScheme::getUIColour (UIColour index) const noexcept
{
...
void TheSeekerLookAndFeel::ColourScheme::setUIColour (UIColour index, Colour newColour) noexcept
{
    if (isPositiveAndBelow (index, numColours))
...
bool TheSeekerLookAndFeel::ColourScheme::operator== (const ColourScheme& other) const noexcept
{
...
//==============================================================================
TheSeekerLookAndFeel::TheSeekerLookAndFeel()  : currentColourScheme (getDarkColourScheme())
{
    initialiseColours();
}

TheSeekerLookAndFeel::TheSeekerLookAndFeel (ColourScheme scheme)  : currentColourScheme (scheme)
{
    initialiseColours();
}

TheSeekerLookAndFeel::~TheSeekerLookAndFeel()  {}

//==============================================================================
void TheSeekerLookAndFeel::setColourScheme (ColourScheme newColourScheme)
{
    currentColourScheme = newColourScheme;
    initialiseColours();
}

TheSeekerLookAndFeel::ColourScheme TheSeekerLookAndFeel::getDarkColourScheme()
{
//    return { 0xff323e44, 0xff263238, 0xff323e44,
//             0xff8e989b, 0xffffffff, 0xff42a2c8,
//             0xffffffff, 0xff181f22, 0xffffffff };
    return { 0xff080808, 0x00000000, 0xaa000000,
        0x00000000, 0xffffffff, 0x00000000,
        0xff000000, 0xffffffff, 0xffffffff };
}

TheSeekerLookAndFeel::ColourScheme TheSeekerLookAndFeel::getMidnightColourScheme()
{
...
TheSeekerLookAndFeel::ColourScheme TheSeekerLookAndFeel::getGreyColourScheme()
{
...
TheSeekerLookAndFeel::ColourScheme TheSeekerLookAndFeel::getLightColourScheme()
{
...
//==============================================================================
class TheSeekerLookAndFeel_DocumentWindowButton   : public Button
{
public:
    TheSeekerLookAndFeel_DocumentWindowButton (const String& name, Colour c, const Path& normal, const Path& toggled)
    ...
    void paintButton (Graphics& g, bool isMouseOverButton, bool isButtonDown) override
    {
        ...
        if (auto* rw = findParentComponentOfClass<ResizableWindow>())
            if (auto lf = dynamic_cast<TheSeekerLookAndFeel*> (&rw->getLookAndFeel()))
                background = lf->getCurrentColourScheme().getUIColour (TheSeekerLookAndFeel::ColourScheme::widgetBackground);
...
private:
    ...
    JUCE_DECLARE_NON_COPYABLE_WITH_LEAK_DETECTOR (TheSeekerLookAndFeel_DocumentWindowButton)
};

Button* TheSeekerLookAndFeel::createDocumentWindowButton (int buttonType)
{
    Path shape;
    ...
    if (buttonType == DocumentWindow::closeButton)
    {
        ...
        return new TheSeekerLookAndFeel_DocumentWindowButton ("close", Colour (0xff9A131D), shape, shape);
    }
    ...
    if (buttonType == DocumentWindow::minimiseButton)
    {
        ...
        return new TheSeekerLookAndFeel_DocumentWindowButton ("minimise", Colour (0xffaa8811), shape, shape);
    }
    ...
    if (buttonType == DocumentWindow::maximiseButton)
    {
        ...
        return new TheSeekerLookAndFeel_DocumentWindowButton ("maximise", Colour (0xff0A830A), shape, fullscreenShape);
    }
...
void TheSeekerLookAndFeel::positionDocumentWindowButtons (DocumentWindow&,
...
void TheSeekerLookAndFeel::drawDocumentWindowTitleBar (DocumentWindow& window, Graphics& g,
...
//==============================================================================
void TheSeekerLookAndFeel::drawButtonBackground (Graphics& g,
                                           Button& button,
...
void TheSeekerLookAndFeel::drawToggleButton (Graphics& g, ToggleButton& button,
...
void TheSeekerLookAndFeel::drawTickBox (Graphics& g, Component& component,
...
//==============================================================================
AlertWindow* TheSeekerLookAndFeel::createAlertWindow (const String& title, const String& message,
...
void TheSeekerLookAndFeel::drawAlertBox (Graphics& g, AlertWindow& alert,
...
int TheSeekerLookAndFeel::getAlertWindowButtonHeight()    { return 40; }
Font TheSeekerLookAndFeel::getAlertWindowTitleFont()      { return Font (18.0f, Font::FontStyleFlags::bold); }
Font TheSeekerLookAndFeel::getAlertWindowMessageFont()    { return Font (16.0f); }
Font TheSeekerLookAndFeel::getAlertWindowFont()           { return Font (14.0f); }

//==============================================================================
void TheSeekerLookAndFeel::drawProgressBar (Graphics& g, ProgressBar& progressBar,
...
void TheSeekerLookAndFeel::drawLinearProgressBar (Graphics& g, ProgressBar& progressBar,
...
void TheSeekerLookAndFeel::drawCircularProgressBar (Graphics& g, ProgressBar& progressBar, const String& progressText)
{
    const auto background = progressBar.findColour (ProgressBar::backgroundColourId);
    const auto foreground = progressBar.findColour (ProgressBar::foregroundColourId);
...
//==============================================================================
int TheSeekerLookAndFeel::getDefaultScrollbarWidth()
{
    return 8;
}

void TheSeekerLookAndFeel::drawScrollbar (Graphics& g, ScrollBar& scrollbar, int x, int y, int width, int height,
...
//==============================================================================
Path TheSeekerLookAndFeel::getTickShape (float height)
{
...
Path TheSeekerLookAndFeel::getCrossShape (float height)
{
...
//==============================================================================
void TheSeekerLookAndFeel::fillTextEditorBackground (Graphics& g, int width, int height, TextEditor& textEditor)
{
...
void TheSeekerLookAndFeel::drawTextEditorOutline (Graphics& g, int width, int height, TextEditor& textEditor)
{
    if (dynamic_cast<AlertWindow*> (textEditor.getParentComponent()) == nullptr)
    {
...
//==============================================================================
Button* TheSeekerLookAndFeel::createFileBrowserGoUpButton()
{
...
void TheSeekerLookAndFeel::layoutFileBrowserComponent (FileBrowserComponent& browserComp,
...
void TheSeekerLookAndFeel::drawFileBrowserRow (Graphics& g, int width, int height,
...
//==============================================================================
void TheSeekerLookAndFeel::drawPopupMenuItem (Graphics& g, const Rectangle<int>& area,
...
void TheSeekerLookAndFeel::getIdealPopupMenuItemSize (const String& text, const bool isSeparator,
...
void TheSeekerLookAndFeel::drawMenuBarBackground (Graphics& g, int width, int height,
...
void TheSeekerLookAndFeel::drawMenuBarItem (Graphics& g, int width, int height,
...
//==============================================================================
void TheSeekerLookAndFeel::drawComboBox (Graphics& g, int width, int height, bool,
                                   int, int, int, int, ComboBox& box)
{
    ...
    Rectangle<int> arrowZone (width - 16, 0, 16, height);
    Path path;
...
Font TheSeekerLookAndFeel::getComboBoxFont (ComboBox& box)
{
    return Font (jmin (12.0f, box.getHeight() * 0.85f));
}

void TheSeekerLookAndFeel::positionComboBoxText (ComboBox& box, Label& label)
{
    label.setBounds (1, 1,
                     box.getWidth() - 16,
                     box.getHeight() - 2);
...
//==============================================================================
void TheSeekerLookAndFeel::drawLinearSlider (Graphics& g, int x, int y, int width, int height,
                                       float sliderPos,
                                       float minSliderPos,
                                       float maxSliderPos,
...
void TheSeekerLookAndFeel::drawRotarySlider (Graphics& g, int x, int y, int width, int height, float sliderPos,
...
void TheSeekerLookAndFeel::drawPointer (Graphics& g, const float x, const float y, const float diameter,
...
//==============================================================================
void TheSeekerLookAndFeel::drawTooltip (Graphics& g, const String& text, int width, int height)
{
...
//==============================================================================
void TheSeekerLookAndFeel::drawConcertinaPanelHeader (Graphics& g, const Rectangle<int>& area,
...
//==============================================================================
void TheSeekerLookAndFeel::drawLevelMeter (Graphics& g, int width, int height, float level)
{
...
//==============================================================================
void TheSeekerLookAndFeel::paintToolbarBackground (Graphics& g, int w, int h, Toolbar& toolbar)
{
...
void TheSeekerLookAndFeel::paintToolbarButtonLabel (Graphics& g, int x, int y, int width, int height,
...
//==============================================================================
void TheSeekerLookAndFeel::drawPropertyPanelSectionHeader (Graphics& g, const String& name,
...
void TheSeekerLookAndFeel::drawPropertyComponentBackground (Graphics& g, int width, int height, PropertyComponent& component)
{
    g.setColour (component.findColour (PropertyComponent::backgroundColourId));
    g.fillRect  (0, 0, width, height - 1);
}

void TheSeekerLookAndFeel::drawPropertyComponentLabel (Graphics& g, int width, int height, PropertyComponent& component)
{
    ignoreUnused (width);
...
int TheSeekerLookAndFeel::getPropertyComponentIndent (PropertyComponent& component)
{
    return jmin (10, component.getWidth() / 10);
}

Rectangle<int> TheSeekerLookAndFeel::getPropertyComponentContentPosition (PropertyComponent& component)
{
...
//==============================================================================
void TheSeekerLookAndFeel::drawCallOutBoxBackground (CallOutBox& box, Graphics& g,
...
//==============================================================================
void TheSeekerLookAndFeel::drawStretchableLayoutResizerBar (Graphics& g, int /*w*/, int /*h*/, bool /*isVerticalBar*/,
...
//==============================================================================
void TheSeekerLookAndFeel::initialiseColours()
{
